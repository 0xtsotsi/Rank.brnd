...
export async function getCompetitorComparisonById(
  ...
  try {
    ...
    return {
      success: false,
      error: error instanceof Error ? error.message : 'Failed to fetch competitor comparison',
    };
  }
}
...
export async function getOrganizationCompetitorComparisons(
  ...
  try {
    ...
    return {
      success: false,
      error: error instanceof Error ? error.message : 'Failed to fetch competitor comparisons',
    };
  }
}
...
export async function getQuickWinOpportunities(
  ...
  try {
    ...
    return {
      success: false,
      error: error instanceof Error ? error.message : 'Failed to fetch quick-win opportunities',
    };
  }
}
...
export async function upsertCompetitorComparison(
  ...
  try {
    ...
    return {
      success: false,
      error: error instanceof Error ? error.message : 'Failed to upsert competitor comparison',
    };
  }
}
...
export async function updateCompetitorComparison(
  ...
  try {
    ...
    return {
      success: false,
      error: error instanceof Error ? error.message : 'Failed to update competitor comparison',
    };
  }
}
...
export async function deleteCompetitorComparison(
  ...
  try {
    ...
    return {
      success: false,
      error: error instanceof Error ? error.message : 'Failed to delete competitor comparison',
    };
  }
}
...
export async function getCompetitorComparisonStats(
  ...
  try {
    ...
    return {
      success: false,
      error: error instanceof Error ? error.message : 'Failed to fetch competitor comparison stats',
    };
  }
}

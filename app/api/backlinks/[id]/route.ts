...
export async function PUT(
  ...
  try {
    ...
    const updates: Partial<Database['public']['Tables']['backlinks']['Update']> = {};
    if (validatedData.sourceUrl !== undefined) updates.source_url = validatedData.sourceUrl;
    if (validatedData.targetUrl !== undefined) updates.target_url = validatedData.targetUrl || null;
    if (validatedData.domainAuthority !== undefined) updates.domain_authority = validatedData.domainAuthority;
    if (validatedData.pageAuthority !== undefined) updates.page_authority = validatedData.pageAuthority;
    if (validatedData.spamScore !== undefined) updates.spam_score = validatedData.spamScore;
    if (validatedData.linkType !== undefined) updates.link_type = validatedData.linkType || null;
    if (validatedData.anchorText !== undefined) updates.anchor_text = validatedData.anchorText || null;
    ...
    if (validatedData.metadata !== undefined) updates.metadata = validatedData.metadata as Database['public']['Tables']['backlinks']['Update']['metadata'];
    if (validatedData.lastVerifiedAt !== undefined) updates.last_verified_at = validatedData.lastVerifiedAt;
